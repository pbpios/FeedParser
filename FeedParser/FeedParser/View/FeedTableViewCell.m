...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.feedTitleLabel setFont:[UIFont boldSystemFontOfSize:16]];
        ...
        NSLayoutConstraint *feedTitleLabelHeightConstraint = [NSLayoutConstraint constraintWithItem:self.feedTitleLabel attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1 constant:20];
        ...
        [NSLayoutConstraint activateConstraints:@[feedTitleLabelHeightConstraint,feedTitleLabelLeadingConstraint,feedTitleLabelTrailingConstraint, feedTitleLabelTopConstraint]];

        
        
        self.feedDescriptionLabel = [[UILabel alloc] init];
        [self.feedDescriptionLabel setFont:[UIFont systemFontOfSize:14]];
        ...
        NSLayoutConstraint *feedDescriptionLabelTrailingConstraint = [NSLayoutConstraint constraintWithItem:self.feedDescriptionLabel attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:self.feedDescriptionLabel.superview attribute:NSLayoutAttributeTrailing multiplier:1 constant:10];
        ...
        NSLayoutConstraint *feedDescriptionLabelBottomConstraint = [NSLayoutConstraint constraintWithItem:self.feedDescriptionLabel attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationGreaterThanOrEqual toItem:self.feedDescriptionLabel.superview  attribute:NSLayoutAttributeBottom multiplier:1 constant:5];
